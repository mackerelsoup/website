// @ts-nocheck
// Source - https://stackoverflow.com/a/46866546
...
var FS_SOURCE = `
    ...
    uniform float     u_distortion = 70;
    uniform float     u_stripe = 10;
    uniform float     u_rgbshift = 10;
    void main() {
...
function init() {
    ...
    [ { source : VS_SOURCE, stage : gl.VERTEX_SHADER },
        { source : FS_SOURCE, stage : gl.FRAGMENT_SHADER }
    ] );
